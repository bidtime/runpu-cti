...
// 系统其它事件,
const BriEvent_SystemOther = 110;
...
const   CPC_GENERAL_ISDIALOUT     =6;//不软摘机，直接拨号
const   CPC_GENERAL_ISSTARTDIAL   =7;//是否准备拨号，或正在拨号
